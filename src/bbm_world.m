classdef bbm_world < world
    properties
        rule = [1, 9, 5, 4, 3, 6, 10, 8, 2, 7, 11, 12, 13, 14, 15, 16];
    endproperties

    methods
        function this = bbm_world(width, height, start_generation_at = uint32(0), world_type = world_preset_type.RANDOM)
